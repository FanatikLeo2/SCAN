...
const RequestForm = () => {
    ...
    return (
        <div className='requestform-main-cont'>
            <div className='requestform-cont'>
                <div className='requestform-text-cont'>
                    <div className='requestform-big-text'>Найдите необходимые данные в пару кликов.</div>

                    <div className='requestform-small-text'>
                        <div className='small-text'>Задайте параметры поиска.</div>
                        <div className='small-text'>Чем больше заполните, тем точнее поиск.</div>
                    </div>
                </div>
                ...
                <div className='requestform-input-cont'>
            ...
            <div className='requestform-images-cont'>
                {clientWidth < 900 ? null 
                :
                <div className='requestform-small-images'>
                    <img src={require('./Document.png')}></img>
                    <img src={require('./Folders.png')} className='img-margin-right'></img>
                </div>
                }
                <div className='requestform-big-image-cont'>
